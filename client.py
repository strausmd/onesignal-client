"""
This module contains code that implements API calls for OneSignal Restful API. Some important
concepts:
...
Two type of API keys are used and it's important to distinguish them. As per their docs
available at
...
class OneSignal(object):
    ...
    def create_player(self, device_type, app_id=None, **kwargs):
        ...
        :param device_type: Required parameter to create a device. 0 = iOS, 1 = Android,
        2 = Amazon,
            3 = WindowsPhone(MPNS), 4 = ChromeApp, 5 = ChromeWebsite, 6 = WindowsPhone(WNS),
            7 = Safari,
            8 = Firefox
    ...
    def player_on_session(self, player_id, **kwargs):
        ...
        :param player_id: Player's ID.
        :param kwargs: Other arguments as given here
    ...
    def player_on_purchase(self, player_id, **kwargs):
        ...
        :param player_id: Player's ID
        :param kwargs: Take other arguments as given on
    ...
    def create_app(self, app_name, **kwargs):
        ...
        :kwargs: Other arguments as given
        https://documentation.onesignal.com/docs/apps-create-an-app
            ...
            safari_apns_p12:	String
                    Your apple push notification p12 certificate file for Safari Push
                    Notifications,
            ...
            chrome_web_sub_domain:	String
                    A subdomain of your choice in order to support Chrome Web Push on Non-HTTPs
                    websites
        :return: Returns HTTP response object which contains a response that, per docs, looks like:
        .. Response:
            {
                ...
                safari_site_origin: "The homename for your website for Safari Push, including
                http or https",
                safari_push_id: "The certificate bundle ID for Safari Web Push",
                safari_icon_16_16: "http://onesignal.com/safari_packages/e4e87830-b954-11e3-811d
                -f3b376925f15/16x16.png",
                safari_icon_32_32: "http://onesignal.com/safari_packages/e4e87830-b954-11e3-811d
                -f3b376925f15/16x16@2.png",
                safari_icon_64_64: "http://onesignal.com/safari_packages/e4e87830-b954-11e3-811d
                -f3b376925f15/32x32@2x.png",
                safari_icon_128_128: "http://onesignal.com/safari_packages/e4e87830-b954-11e3
                -811d-f3b376925f15/128x128.png",
                safari_icon_256_256: "http://onesignal.com/safari_packages/e4e87830-b954-11e3
                -811d-f3b376925f15/128x128@2x.png",
    ...
    def update_app(self, **kwargs):
        ...
        :param kwargs: Other arguments as given on
            ...
            [{
                {
                    ...
                    apns_certificates: "Your apns certificate",
                    safari_apns_cetificate: "Your Safari APNS certificate",
                    safari_site_origin: "The homename for your website for Safari Push,
                    including http or https",
                    safari_push_id: "The certificate bundle ID for Safari Web Push",
                    safari_icon_16_16:
                    "http://onesignal.com/safari_packages/92911750-242d-4260-9e00-9d9034f139ce
                    /16x16.png",
                    safari_icon_32_32:
                    "http://onesignal.com/safari_packages/92911750-242d-4260-9e00-9d9034f139ce
                    /16x16@2.png",
        ...
        .. Response::
            {
                  ...
                  http or https",
                  safari_push_id: "The certificate bundle ID for Safari Web Push",
                  safari_icon_16_16: "http://onesignal.com/safari_packages/92911750-242d-4260
                  -9e00-9d9034f139ce/16x16.png",
                  safari_icon_32_32: "http://onesignal.com/safari_packages/92911750-242d-4260
                  -9e00-9d9034f139ce/16x16@2.png",
                  safari_icon_64_64: "http://onesignal.com/safari_packages/92911750-242d-4260
                  -9e00-9d9034f139ce/32x32@2x.png",
                  safari_icon_128_128:
                  "http://onesignal.com/safari_packages/92911750-242d-4260-9e00-9d9034f139ce
                  /128x128.png",
                  safari_icon_256_256:
    ...
    def export_players_to_csv(self, app_auth_key, app_id=None):
        ...
        :param app_id: App's ID.
        :return: Returns HTTP response object which contains a response,per their docs,
        that looks like:
        .. Response::
            {
                "csv_file_url":
                "https://onesignal.com/csv_exports/b2f7f966-d8cc-11e4-bed1-df8f05be55ba
                /users_184948440ec0e334728e87228011ff41_2015-11-10.csv"
            }
        """
        app_id = app_id if app_id else self.app_id
    ...
    def create_notification(self, contents, heading='', url='',
        ...
        """
        Creates a notification by sending a notification to
        https://onesignal.com/api/v1/notifications
        :param heading: push notification heading / title
        :param url: target url for push notification. User will be redirected to this url on
        clicking
        push notification
        :param app_id: App's ID
    ...
    def get_notification(self, app_id, notification_id, app_auth_key):
        """
        Gets a notification by sending a GET to
    ...
    def delete_notification(self, notification_id):
        """
        Deletes a notification by sending a DELETE to
        https://onesignal.com/api/v1/notifications/:id?app_id=:app_id
